"""Paginação por cursor, cópia própria do domínio `workflow.solicitacoes`
(F10, T2, agente A1).

Mesmo padrão replicado por todas as fases anteriores (`app.pessoas.paginacao`,
`app.apuracao.tratamento.paginacao`, `app.marcacao.consulta.paginacao`, ...):
cada domínio tem a sua própria cópia, nunca importada de outra fase (ver
docstring de `app.apuracao.tratamento.paginacao`, "crie sua própria
cópia... não importe").
"""
