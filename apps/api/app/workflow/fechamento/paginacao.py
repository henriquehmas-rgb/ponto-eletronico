"""Paginação por cursor, cópia própria para o domínio `fechamento` (F10/A2).

Mesmo padrão replicado por todas as fases anteriores (`app.apuracao.
tratamento.paginacao`, `app.apuracao.banco_horas.paginacao`, `app.pessoas.
...
"crie sua própria cópia... não importe").
