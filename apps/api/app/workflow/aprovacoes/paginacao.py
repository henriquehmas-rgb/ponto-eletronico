"""Paginação por cursor, cópia própria do domínio `workflow.aprovacoes`
(F10, T3, agente A1) -- mesmo padrão de
`app.workflow.solicitacoes.paginacao` (cópia irmã, mesmo pacote de fase,
nunca importada entre si -- cada domínio tem a sua, ver docstring daquele
módulo para o precedente completo)."""
