"""Paginacao por cursor, self-contained para o dominio `webhooks` (mesmo
padrao de `app/terminais/paginacao.py`, `app/pessoas/paginacao.py` -- cada
dominio guarda a propria copia para nao acoplar a modulo de outro
agente/fase, ver docstring daqueles modulos)."""
