"""Geracao do arquivo `senior` (F13/A7, T18). Ver docstring de `app.
integracoes.folha.senior` para o debito tecnico completo antes de ler este
modulo.
...
para o parceiro Senior. Nenhuma posicao fixa de campo e aplicada porque
...
def gerar(contexto: ContextoExportacaoFolha) -> ArquivoFolhaGerado:
    ...
    nome_arquivo = (
        ...
        f"senior-{contexto.competencia_folha}-{contexto.processamento_id}.csv"
    )
