"""Geracao do arquivo `questor` (F13/A7, T18). Ver docstring de `app.
integracoes.folha.questor` para o debito tecnico completo antes de ler este
modulo.
...
para o parceiro Questor. Nenhuma posicao fixa de campo e aplicada porque
...
def gerar(contexto: ContextoExportacaoFolha) -> ArquivoFolhaGerado:
    ...
    nome_arquivo = (
        ...
        f"questor-{contexto.competencia_folha}-{contexto.processamento_id}.csv"
    )
