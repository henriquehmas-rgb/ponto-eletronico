"""Exportador de folha para a Contmatic (Contmatic, ERP contabil/folha),
parceiro `contmatic` do enum `IntegracaoFolha.parceiro` (F13/A7, T18).
...
Contmatic, apenas documentacao PUBLICA de fluxo/tela do modulo de folha --
...
-- mesmo achado que Senior e Questor, os outros dois parceiros desta tarefa
com "fluxo documentado, campo a campo atras de login"). Diferente de `app.
...
pelo menos seja identificavel como destinado a Contmatic, sem fingir
qualquer fidelidade de posicao de campo que a pesquisa nao confirmou.
"""

from __future__ import annotations

from app.integracoes.folha.comum import registro
from app.integracoes.folha.contmatic.layout import gerar

registro.registrar("contmatic", gerar)
