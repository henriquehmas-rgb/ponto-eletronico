"""Geracao do arquivo `contmatic` (F13/A7, T18). Ver docstring de `app.
integracoes.folha.contmatic` para o debito tecnico completo antes de ler
este modulo.
...
para o parceiro Contmatic. Nenhuma posicao fixa de campo e aplicada porque
...
def gerar(contexto: ContextoExportacaoFolha) -> ArquivoFolhaGerado:
    ...
    nome_arquivo = (
        ...
        f"contmatic-{contexto.competencia_folha}-{contexto.processamento_id}.csv"
    )
