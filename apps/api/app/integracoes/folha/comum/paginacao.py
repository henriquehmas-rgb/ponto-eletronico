"""Paginacao por cursor de `listarIntegracoesFolha` (F13/A5, T15).

Copia deliberada do padrao ja usado por cada dominio deste projeto (por
exemplo `app.pessoas.paginacao`) -- duplicado de proposito, mesma razao ja
documentada nos outros: nao existe `app.comum.paginacao` compartilhado, e
criar um agora seria mudar o padrao estabelecido no meio da fase, fora do
escopo desta tarefa.
"""
