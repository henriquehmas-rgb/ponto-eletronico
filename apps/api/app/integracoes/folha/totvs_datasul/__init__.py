"""Exportador de folha para TOTVS Datasul (PE0540). Ver `exportador.py`
...
from app.integracoes.folha.totvs_datasul.exportador import NOME_EXIBICAO, PARCEIRO, gerar
