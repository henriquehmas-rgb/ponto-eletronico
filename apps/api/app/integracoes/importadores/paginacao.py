"""Paginação por cursor, self-contained para `app.integracoes.importadores`
(mesmo padrão de `app/fiscal/rep_p/paginacao.py`, `app/terminais/
paginacao.py` -- cada domínio guarda a própria cópia para não acoplar a
módulo de outro agente/fase, ver `app/biometria/comum.py`)."""
