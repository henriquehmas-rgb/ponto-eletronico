"""Paginação por cursor, self-contained para o domínio `fiscal.rep_p` (mesmo
padrão de `app/terminais/paginacao.py`, `app/pessoas/paginacao.py` -- cada
domínio guarda a própria cópia para não acoplar a módulo de outro
agente/fase, ver `app/biometria/comum.py`)."""
