...
/**
 * Confirmação genérica para ações de alto impacto (exclusão de webhook). O
 * design system não fixa um `AlertDialog` dedicado (F9a §4/§9) — compõe
 * `Dialogo` (T4) com o botão destrutivo, sem duplicar o primitivo congelado.
 * Cópia local do mesmo padrão independente em
 * `paineis/cadastros/_shared/dialogo-confirmacao.tsx` (F9a/A2) e
 * `paineis/escalas/dialogo-confirmacao.tsx` (F9a/A3).
 */
